...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \mint{c}|int num[3]={10, 20, 60};|
    \item num is the array of 3 integers, \mint{c}|num[0]| is \mint{c}|10|, \ldots
    \mint{c}|int num[]={40, 50, 60, 70, 70, 80};|
    \item num is the array of 6 integers
    \mint{c}|int num[10]={40, 50, 60};|
    \item num is the array of 10 integers
    \item \mint{c}|num[0]| is \mint{c}|40|, \mint{c}|num[1]| is \mint{c}|50|, \mint{c}|num[2]| is \mint{c}|60|
    \item \mint{c}|num[3]|, \mint{c}|num[4]|, \ldots, \mint{c}|num[9]| are \mint{c}|0|
  \end{itemize}
\end{frame}
