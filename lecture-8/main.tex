...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item \mintinline{c}|factorial(4) = ?|
    \item \mintinline{c}|factorial(3) = ?|
    \item \mintinline{c}|factorial(2) = ?|
    \item \mintinline{c}|factorial(1) = ?|
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  \frametitle{Function Call Graph + Stacks}
  \begin{itemize}
    \item<1-> \mintinline{c}|factorial(4) = 4 * (3 * (2 * 1))|
    \item<2-> \mintinline{c}|factorial(3) = 3 * (2 * 1)|
    \item<3-> \mintinline{c}|factorial(2) = 2 * 1|
    \item<4-> \mintinline{c}|factorial(1) = 1|
  \end{itemize}
\end{frame}
