...
\begin{frame}[fragile]
  ...
  <p>
    <b>Algorithm:</b> Goldbach
    <b>Input:</b> n
    <b>Output:</b> 0 if conjecture is incorrect else 1
  </p>
  \begin{minted}[bgcolor=Black]{c}
for(i from 2 to n/2)
  j = n – i
...
\begin{frame}[fragile]
  ...
  <p>
    <b>Algorithm:</b> is\_prime
    <b>Input:</b> n
    <b>Output:</b> 1 if n is prime else 0
  </p>
  \begin{minted}[bgcolor=Black]{c}
...
\begin{frame}[fragile]
  ...
  <p>
    <b>Algorithm:</b> next\_prime\_number<br />
