...
printf("This is %s\n", "a string\n");
    ...
    \begin{itemize}
      ...
      \item Terminated by the \textit{\color{Orange} null char} \mint{c}|'\0'|
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item
      \mint{c}|strcpy(dst_str, src_str)|: copy the
      \mint{c}|src_str| to the
      \mint{c}|dst_str| including NULL
...
\begin{frame}
  ...
  \begin{itemize}
    \item
      \mint{c}|strcat(dst_str, src_str)|: Append the
      \mint{c}|src| string to the end of
      \mint{c}|dst| including NULL
    \item
      \mint{c}|src| is a
      \textbf{\color{YellowOrange} constant} string
    \item
      \mint{c}|dst| should have
